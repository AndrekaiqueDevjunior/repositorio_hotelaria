      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {resultado && (
          <div className={`rounded-lg p-6 ${
            ...
            <div className="space-y-4">
              ...
              {resultado.test_data && (
                <div>
                  <strong>Dados do Teste:</strong>
                  <pre className="text-xs bg-white p-2 rounded mt-1 overflow-auto">
                    {JSON.stringify(resultado.test_data, null, 2)}
                  </pre>
                </div>
              )}

              {/* Resposta Cielo */}
              {resultado.cielo_response && (
                <div>
                  <strong>Resposta Cielo:</strong>
                  <pre className="text-xs bg-white p-2 rounded mt-1 overflow-auto">
                    {JSON.stringify(resultado.cielo_response, null, 2)}
                  </pre>
                </div>
              )}

              {/* Próximos Passos */}
              {resultado.next_steps && (
                <div>
                  <strong>Próximos Passos:</strong>
                  <ol className="text-sm list-decimal list-inside mt-1">
                    {resultado.next_steps.map((step, index) => (
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ol className="text-sm list-decimal list-inside space-y-1">
            <li>Verifique se o status Cielo mostra "production" e credenciais OK</li>
            <li>Use o cartão de teste: 4242424242424242</li>
