...
if r.status_code == 200:
    ...
    if r.status_code == 200:
        ...
        quartos = response_data['quartos']  # Corrigido: pegar do objeto response
        ...
        for quarto in quartos:
            ...
            # Guardar um quarto disponível para teste
            if status == 'LIVRE' and quarto_disponivel is None:
    ...
    if r.status_code == 200:
        ...
        if clientes:
            ...
            # Usar quarto disponível encontrado ou buscar um
            if quarto_disponivel:
                quarto_teste = quarto_disponivel
            else:
                r = requests.get(f'{base_url}/quartos/disponiveis', cookies=cookies)
                if r.status_code == 200 and r.json():
                    quarto_teste = r.json()[0]
                else:
            ...
            reserva_data = {
                ...
                'valor_diaria': quarto_teste.get('diaria', 150.00),
                'num_diarias': 1
            }
