...
from app.services.antifraude_service import AntifraudeService
...
from app.repositories.usuario_pontos_repo import UsuarioPontosRepository
...
async def test_anti_fraude_relacionamentos():
    ...
    try:
        ...
        analise_cliente = await AntifraudeService.analisar_cliente(cliente["id"])
        ...
        operacao_antifraude = await db.operacaopontofraude.create({
        ...
        usuario_pontos_repo = UsuarioPontosRepository(db)
        
        usuario_pontos = await usuario_pontos.create({
            "clienteId": cliente["id"],
            "saldo": 100
        })
        ...
        resumo = {
            ...
            "relacionamentos": {
                ...
                "cliente_antifraude": len(cliente_completo.operacoesAntifraude),
