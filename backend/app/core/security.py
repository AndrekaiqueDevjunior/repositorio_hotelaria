...
DEV_FALLBACK_SECRET_KEY = f"dev-secret-{secrets.token_urlsafe(32)}"
...
def create_access_token(data: dict) -> str:
    ...
    if not secret_key:
        ...
        secret_key = DEV_FALLBACK_SECRET_KEY  # fallback apenas para desenvolvimento
...
async def verify_token_not_blacklisted(token: str) -> bool:
    ...
    try:
        ...
        payload = jwt.decode(
            token,
            os.getenv("SECRET_KEY", DEV_FALLBACK_SECRET_KEY),
            algorithms=["HS256"],
